...
% catch NaN for axis call                 GK, 22.06.2015  0.7-->0.8
% added color id to title                 GK, 09.10.2015  0.8-->0.9
...
date1 = datevec(values.start_time);  
