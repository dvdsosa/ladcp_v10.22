...
% replace julian/gregorian with datenum/datevec  GK, 10.02.2017  0.1-->1
...
if ~isempty(params.time_start) & ~isempty(params.time_end)
  time_start = datenum(params.time_start) - params.general_cut_slack/1440;
  time_end = datenum(params.time_end) + params.general_cut_slack/1440;
  good = ( data.time_datenum>=time_start & data.time_datenum<=time_end );
