...
% fixed a problem when reloading data             GK, 29.04.2016  0.4-->0.5
...
if exist(['data/ctdtime/ctdtime',int2str0(stn,3),'.mat'],'file')
  ...
  load(['data/ctdtime/ctdtime',int2str0(stn,3)])
...
% tim_sadcp		vector containing the time in Matlab datenum days
