...
%  	'ladcp.cnv data/raw_ctdtime/p408',int2str0(stn,3),'.tim'])
...
timctd = data(:,2) + julian([2006,1,0,0,0,0]);
data = data(:,[5,6,13]);
...
%
% extract start and end time of CTD
%
...
if str2num(version('-release'))>=14
  eval(['save data/ctdtime/ctdtime',int2str0(stn,3),' timctd data -v6'])
else
